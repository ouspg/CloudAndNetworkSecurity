...
Download the custom created lightweight Xubuntu VM from [here](https://a3s.fi/swift/v1/CloudAndNetworkSecurity/Xubuntu-qcow2.tar.xz):


Image name|Image size|Download Link
:-:|:-:|:-:
Xubuntu linux | 4.8 gb | [Xubuntu download](https://a3s.fi/swift/v1/CloudAndNetworkSecurity/Xubuntu-qcow2.tar.xz)
